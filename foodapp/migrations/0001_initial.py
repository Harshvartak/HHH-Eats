# Generated by Django 3.1.2 on 2020-11-06 16:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r_logo', models.FileField(upload_to='rest_logo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodapp.menuitem')),
                ('orderedBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodapp.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Menu',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('r_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodapp.restaurant')),
                ('r_menu', models.ManyToManyField(to='foodapp.MenuItem')),
            ],
        ),
        migrations.AddField(
